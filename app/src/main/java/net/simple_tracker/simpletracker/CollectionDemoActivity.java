        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (args.getInt(ARG_OBJECT) == 1) {
                ...
                for (String d : dates) {
                    ...
                    ((TextView) rootView.findViewById(android.R.id.text1)).setText(d);

                    for (Outlay o : outlays) {
                        ((TextView) rootView.findViewById(android.R.id.text2)).setText(String.valueOf(o.getCount()));
                ...
                for (Category c : categories) {
                    ...
                    if (outlays.size() != 0) {
                        ((TextView) rootView.findViewById(android.R.id.text1)).setText(c.getCategoryName());
                    }
